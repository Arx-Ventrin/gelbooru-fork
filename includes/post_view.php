<?php
	...
	else
	{
		...
		if (preg_match("/\.mp4$/", $post_data['image']) == 1) {
		...
		{
			echo '<img alt="" id="image" onclick="Note.toggle();" src="f6ca1c7d5d00a2a3fb4ea2f7edfa0f96a6d09c11717f39facabad2d724f16fbb/images/'.$post_data['directory'].'/'.$post_data['image'].'" style="margin-right: 70px;"/>';
		}
